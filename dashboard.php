...
<body class="bg-gray-100">
    ...
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        ...
        <div class="bg-white shadow rounded-lg mb-8">
            <div class="px-4 py-5 sm:p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <a href="manage-users.php" class="bg-blue-50 hover:bg-blue-100 p-4 rounded-lg text-center transition-colors">
                        <i class="fas fa-users-cog text-2xl text-blue-600 mb-2"></i>
                        <p class="text-sm font-medium text-blue-900">Manage Users</p>
                    </a>
                    <a href="view-products.php" class="bg-green-50 hover:bg-green-100 p-4 rounded-lg text-center transition-colors">
                        <i class="fas fa-boxes text-2xl text-green-600 mb-2"></i>
                        <p class="text-sm font-medium text-green-900">View All Products</p>
                    </a>
                    <a href="scan-analytics.php" class="bg-purple-50 hover:bg-purple-100 p-4 rounded-lg text-center transition-colors">
                        <i class="fas fa-chart-bar text-2xl text-purple-600 mb-2"></i>
                        <p class="text-sm font-medium text-purple-900">Scan Analytics</p>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="bg-white shadow rounded-lg">
                <div class="px-4 py-5 sm:p-6">
                    ...
                    <div class="mt-4 text-center">
                        <a href="manage-users.php" class="text-indigo-600 hover:text-indigo-500 text-sm font-medium">Manage all users →</a>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white shadow rounded-lg">
                <div class="px-4 py-5 sm:p-6">
                    <h3 class="text-lg leading-6 font-medium text-gray-900 mb-4">Top Users by Scans</h3>
                    <div class="space-y-4">
                        <?php foreach ($scan_stats as $index => $stat): ?>
                            <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 w-8 h-8 bg-indigo-100 rounded-full flex items-center justify-center">
                                        <span class="text-sm font-medium text-indigo-600"><?php echo $index + 1; ?></span>
                                    </div>
                                    <div class="ml-3">
                                        <p class="text-sm font-medium text-gray-900"><?php echo htmlspecialchars($stat['name']); ?></p>
